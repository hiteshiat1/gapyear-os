      ...
      <section className="border-b border-slate-200 bg-slate-50">
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 max-w-3xl">
            ...
            <h1 className="mt-3 text-4xl font-semibold tracking-tight sm:text-5xl">A-Levels Portfolio</h1>
            <p className="mt-5 text-lg leading-8 text-slate-600">
              A structured record of academic progress, projects, and evidence built up during A-Level study.
            </p>
          </div>
        </div>
      </section>
