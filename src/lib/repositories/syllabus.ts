...
async function ensureSubject(definition: SyllabusDefinition): Promise<Subject> {
  ...
  return {
    ...
    specificationCode: data.specification_code ?? null,
    specificationOptions: data.specification_options ?? null,
    achievedGrade: data.achieved_grade,
    targetGrade: data.target_grade,
    schoolPredictedGrade: data.school_predicted_grade ?? null,
