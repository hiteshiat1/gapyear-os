  ...
  public: {
    Tables: {
      ...
      student_subjects: Table<{
        ...
        school_predicted_grade: string | null;
        target_grade: string | null;
        specification_confirmation_status: string;
        topic_support_status: string;
        active: boolean;
        created_at: string;
        updated_at: string;
      ...
      student_specification_options: Table<{
        id: string;
        owner_id: string;
      ...
      study_availability: Table<{
        id: string;
        owner_id: string;
        weekday_default_minutes: number | null;
        weekend_default_minutes: number | null;
